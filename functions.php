<?php
/**
 * subliquidawp functions and definitions
 *
...
if ( ! defined( 'SUBLIQUIDAWP_VERSION' ) ) {
	...
	define( 'SUBLIQUIDAWP_VERSION', '1.0.4' );
}
...
if ( ! function_exists( 'subliquidawp_setup' ) ) :
	 ...
	 */
	function subliquidawp_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on subliquidawp, use a find and replace
		 * to change 'subliquidawp' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'subliquidawp', get_template_directory() . '/languages' );
		...
		add_theme_support(
			'custom-background',
			apply_filters(
				'subliquidawp_custom_background_args',
				array(
...
add_action( 'after_setup_theme', 'subliquidawp_setup' );
 ...
 */
function subliquidawp_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'subliquidawp_content_width', 640 );
}
add_action( 'after_setup_theme', 'subliquidawp_content_width', 0 );
 ...
 */
function subliquidawp_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'subliquidawp' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'subliquidawp' ),
...
add_action( 'widgets_init', 'subliquidawp_widgets_init' );
